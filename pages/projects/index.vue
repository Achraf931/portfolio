<template>
  <div class="mb-10 min-h-screen">
    <h1 v-observe-visibility="{ callback: this.visibilityTop, once: true }" class="is-visible-top mt-20 mb-10 text-4xl md:text-5xl lg:text-6xl text-center md:text-left dark:text-white">Projets</h1>
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      <client-only>
        <vue-aspect-ratio v-observe-visibility="{ callback: this.visibilityChanged, once: true }" ar="16:9" class="is-visible w-full bg-black dark:bg-dark relative project">
