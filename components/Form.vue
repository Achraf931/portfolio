<template>
  <section class="bg-grayCustom mt-32 p-6 md:p-10 lg:p-20 dark:bg-dark">
    <div class="text-center mb-10 md:text-left">
      <h2 v-observe-visibility="{ callback: this.visibilityChanged, once: true }"
    ...
    <form v-observe-visibility="{ callback: this.visibilityChanged, once: true }" @submit.prevent="sendMail"
          method="post" class="is-visible max-w-screen-md" novalidate>
      <div class="flex flex-col md:flex-row justify-between">
        <div v-observe-visibility="{ callback: this.visibilityChanged, once: true }"
      ...
      <button v-observe-visibility="{ callback: this.visibilityChanged, once: true }"
              ref="button"
